 ...
 Cyber Security student working on Sly Systems and hands-on cybersecurity labs, open to collaboration on web development and cybersecurity projects, currently learning network security, React, Typescript and programming in C, C#, Python, and JavaScript, with a strong interest in building secure and scalable systems


## 🌐 Socials:
[![X](https://img.shields.io/badge/X-black.svg?logo=X&logoColor=white)](https://x.com/https://x.com/redwristslyy) 
